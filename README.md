...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/globre-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10916&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/globre-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `globre` can be installed with:

```
conda install globre
```

It is possible to list all of the versions of `globre` available on your platform with:
